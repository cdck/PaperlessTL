...
import com.xlk.paperlesstl.view.admin.adapter.AdminRvAdapter;
import com.xlk.paperlesstl.view.admin.bean.AdminFunctionBean;
import com.xlk.paperlesstl.view.admin.fragment.after.annotation.AdminAnnotationFragment;
import com.xlk.paperlesstl.view.admin.fragment.after.archive.ArchiveFragment;
...
import com.xlk.paperlesstl.view.admin.fragment.after.vote.VoteResultPresenter;
import com.xlk.paperlesstl.view.admin.fragment.mid.camera.AdminCameraControlFragment;
import com.xlk.paperlesstl.view.admin.fragment.mid.chat.AdminChatFragment;
import com.xlk.paperlesstl.view.admin.fragment.mid.devcontrol.AdminDevControlFragment;
import com.xlk.paperlesstl.view.admin.fragment.mid.screen.ScreenFragment;
import com.xlk.paperlesstl.view.admin.fragment.mid.votemanage.AdminVoteManageFragment;
import com.xlk.paperlesstl.view.admin.fragment.mid.votemanage.AdminVoteManagePresenter;
import com.xlk.paperlesstl.view.admin.fragment.pre.agenda.AdminAgendaFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.bind.SeatBindFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.camera.AdminCameraManageFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.election.AdminElectionFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.file.AdminFileFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.function.FunctionFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.meetingManage.MeetingManageFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.member.MemberFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.tablecard.TableCardFragment;
import com.xlk.paperlesstl.view.admin.fragment.pre.vote.AdminVoteFragment;
import com.xlk.paperlesstl.view.admin.fragment.reserve.meet.ReserveMeetingFragment;
import com.xlk.paperlesstl.view.admin.fragment.reserve.email.SendEmailFragment;
import com.xlk.paperlesstl.view.admin.fragment.reserve.task.TaskManagerFragment;
import com.xlk.paperlesstl.view.admin.fragment.system.device.AdminDeviceManageFragment;
import com.xlk.paperlesstl.view.admin.fragment.system.member.FrequentlyMemberFragment;
import com.xlk.paperlesstl.view.admin.fragment.system.other.AdminOtherFragment;
import com.xlk.paperlesstl.view.admin.fragment.system.room.AdminRoomManageFragment;
import com.xlk.paperlesstl.view.admin.fragment.system.seat.SeatArrangementFragment;
import com.xlk.paperlesstl.view.admin.fragment.system.secretary.AdminSecretaryManageFragment;
...
public class AdminActivity extends BaseActivity<AdminPresenter> implements AdminContract.View {
    ...
    private void showFragment(int level1Index, int level2Index) {
        LogUtils.i(TAG, "showFragment level1Index=" + level1Index + ",level2Index=" + level2Index);
...
//        ft.commit();//出现异常：Can not perform this action after onSaveInstanceState
    ...
    private void afterFragment(int level2Index, FragmentTransaction ft) {
        switch (level2Index) {
            case 0:
                ...
                bundle.putBoolean("isFromMeet", false);
    ...
    public void updateMeetStatus(InterfaceMeet.pbui_Item_MeetMeetInfo item) {
        ...
        LogUtils.i(TAG, "updateMeetStatus meetId=" + currentMeetId + ",status=" + item.getStatus());
