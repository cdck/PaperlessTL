...
//            }
    ...
    public void queryDirPermission(int dirId) {
        ...
        if (dirPermission != null) {
            ...
            LogUtils.i(TAG, "queryDirPermission " + memberidList);
    ...
    public void setCurrentSortFileDirId(int dirId) {
        ...
        LogUtils.i(TAG, "setCurrentSortFileDirId dirId=" + dirId);
    }
    ...
    public void setCurrentDirId(int dirId) {
        currentDirId = dirId;
        LogUtils.i(TAG, "setCurrentDirId dirId=" + dirId);
    }

    public void setCurrentHistoryDirId(int dirId) {
        currentHistoryDirId = dirId;
        LogUtils.i(TAG, "setCurrentHistoryDirId dirId=" + dirId);
    }
    ...
    public void queryFileByDir(int dirId) {
            ...
            LogUtils.i(TAG, "queryFileByDir dirId=" + dirId);
    ...
    public void exit() {
        LogUtils.i(TAG, "exit currentMeetId=" + currentMeetId);
