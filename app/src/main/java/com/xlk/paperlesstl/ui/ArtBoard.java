...
import static com.xlk.paperlesstl.view.draw.DrawPresenter.launchPersonId;
import static com.xlk.paperlesstl.view.draw.DrawPresenter.localOperids;
import static com.xlk.paperlesstl.view.draw.DrawPresenter.mSrcmemid;
import static com.xlk.paperlesstl.view.draw.DrawPresenter.mSrcwbid;
import static com.xlk.paperlesstl.view.draw.DrawPresenter.pathList;
...
//        currentArtBoardHeight = height;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isCreate) {
            ...
            LogUtils.e(TAG, "DrawBoard.onMeasure : --> width= " + width + ", height= " + height);
    ...
    public void initCanvas() {
        ...
        LogUtils.e(TAG, "initCanvas :  --> artBoardWidth= " + artBoardWidth + ", artBoardHeight= " + artBoardHeight);
    ...
    private void drag(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                LogUtils.e(TAG, "drag -->artBoard= (" + artBoardWidth + ", " + artBoardHeight + "), screen= (" + screenWidth + "," + screenHeight + ")");
                //右
                r = artBoardWidth + l;
...
//                LogUtils.d(TAG, "drag -->" + "拖动后画板的宽高：" + currentArtBoardWidth + " , " + currentArtBoardHeight);
                break;
            default:
                break;
        }
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (currentDrawGraphics == DRAW_SLINE) {
                    //添加按下时的点
                    DrawPresenter.points.add(new PointF(x, y));
                }
                invalidate();
                break;
            case MotionEvent.ACTION_MOVE:
            ...
            case MotionEvent.ACTION_UP:
                if (currentDrawGraphics != DRAW_TEXT /*&& currentDrawGraphics != DRAW_ERASER*/) {
                    ...
                    LogUtils.d(TAG, "onTouchEvent: LocalPathList.size() : " + LocalPathList.size());
                }
    ...
    private void addDrawShape(int type, List<Float> allpt) {
        ...
        for (int i = 0; i < allpt.size(); i++) {
            LogUtils.e(TAG, "addDrawShape   --->>> " + allpt.get(i));
        }
        ...
        for (int i = 0; i < LocalSharingPathList.size(); i++) {
            ...
            while (sc < 1) {
                ...
                if (Math.abs((int) fa[0] - (int) x) <= 20 && Math.abs((int) fa[1] - (int) y) <= 20) {
                    sc = 1;
                    LogUtils.e(TAG, "eraser: 查找到对应的坐标,撤销当前path...............................................................................");
                    long srcwbid = mSrcwbid;
                    long utcstamp = System.currentTimeMillis();
                    //操作ID 发送之前最后一个的操作ID
...
//        float remainWidth = currentArtBoardWidth - fx;//可容许显示文本的宽度
        ...
        LogUtils.e(TAG, "drawText:   --->>> 字符串的宽度： " + width + "  可容许显示的宽度："
